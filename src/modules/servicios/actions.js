...
export async function fetchSevircios({commit}){
    try{
        ...
        commit('servicioError',e.message)
        console.log('servicioError',e.message)
    }finally{
        console.log('la peticion para obtener  los servicios a finalizado')
    }
